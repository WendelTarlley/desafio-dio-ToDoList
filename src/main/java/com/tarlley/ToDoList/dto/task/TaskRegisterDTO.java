...
public record TaskRegisterDTO(String title, String description, TaskStatus status, TaskPriority priority, LocalDateTime creationDate, LocalDateTime completionDate, TaskList taskList, List<Category> categories) {
